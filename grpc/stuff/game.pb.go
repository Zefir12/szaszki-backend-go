...
type SaveGameRequest struct {
	...
	Pgn           string                 `protobuf:"bytes,4,opt,name=pgn,proto3" json:"pgn,omitempty"`
...
const file_proto_game_proto_rawDesc = "" +
	"\n" +
	"\x10proto/game.proto\x12\x04game\"\x84\x01\n" +
	"\x0fSaveGameRequest\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\rR\x06gameId\x12\"\n" +
	"\ruser_id_white\x18\x02 \x01(\rR\vuserIdWhite\x12\"\n" +
	"\ruser_id_black\x18\x03 \x01(\rR\vuserIdBlack\x12\x10\n" +
	"\x03pgn\x18\x04 \x01(\tR\x03pgn\"F\n" +
...
var file_proto_game_proto_depIdxs = []int32{
	0, // 0: game.GameService.SaveGame:input_type -> game.SaveGameRequest
	1, // 1: game.GameService.SaveGame:output_type -> game.SaveGameResponse
